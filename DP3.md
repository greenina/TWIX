...
2. Put three items that you think are eco-friendly and one item that you think is not, to the wish list. 
   ...
   - During this task, the user gets to face where they have to select their companion and name it. 

3. Make your companion's state "healthy"

   - The state of the companion was intended to 
   - We planned the users to watch the "growth" of the companion as they  
...
[Prototype link](c11.kr/TWIX_prototype)
...
- <span style="color:red">Include non-ecofriendly items as well as eco-friendly item</span>
...
- 2 ways of accessing to lowest price shopping mall
    ...
    We chose to support both types of users. 
